...
const COLORS = ["#f36747", "#f197a2",  "#4360a8","#3cc6ed","#842d73","#ee316b","#4152a5","#ffb137","#5ce5aa"]
...
function App() {
  ...
  const setRandomColor = () => {
    ...
    setColor(COLORS[(COLORS.indexOf(color) - 1 == COLORS.length) ? 0 : COLORS.indexOf(color) + 1])
  }
  ...
  const onClick = (event: any) => {
    ...
    setRandomColor();
    setColors((currentState) => [ ...(currentState), {
      y: event.clientY,
      x: event.clientX,
